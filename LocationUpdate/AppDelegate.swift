...
extension AppDelegate: CLLocationManagerDelegate {
    ...
    func newVisitReceived(location: CLLocation) {
        ...
        let request = UNNotificationRequest(identifier: location.timestamp.description, content: content, trigger: trigger)
